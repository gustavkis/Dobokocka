...
function kattintas() {
    ...
    if (x < 5) {
        ...
        if (randSzam == 1) {
            document.getElementById("kep").src = "/IMG/kocka_1.svg";
        }
        if (randSzam == 2) {
            document.getElementById("kep").src = "/IMG/kocka_2.svg";
        }
        if (randSzam == 3) {
            document.getElementById("kep").src = "/IMG/kocka_3.svg";
        }
        if (randSzam == 4) {
            document.getElementById("kep").src = "/IMG/kocka_4.svg";
        }
        if (randSzam == 5) {
            document.getElementById("kep").src = "/IMG/kocka_5.svg";
        }
        if (randSzam == 6) {
            document.getElementById("kep").src = "/IMG/kocka_6.svg";
        }
